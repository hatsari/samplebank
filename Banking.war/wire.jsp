...
<html>
	...
	<body>
	    ...
	    <table width=480 bgcolor=white border="0"> 
            ...
            <tr>
                <td bgcolor=#ffe600 border="0" align=center height=70> <a href="save.jsp"><img src="img/p1-save.png" alt="" width=100 height=50></img></a> </td>
                <td bgcolor=#ffe600 border="0" align=center height=70> <a href="wire.jsp"><img src="img/p1-wire.png" alt="" width=100 height=50></img></a> </td>
            </tr>
            <tr>
                <td bgcolor=#cdffff width=240 align=center height=50 border="0"> <p class="ns" style="color:black;font-size:20px;"> 이체 금액</p> </td>
                <td bgcolor=#cdffff width=240 align=center height=50 border="0"> 
                    <form action="wire_result.jsp" method="post">  
                        <fieldset>
